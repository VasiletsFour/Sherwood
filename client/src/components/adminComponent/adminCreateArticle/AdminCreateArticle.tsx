...
import {UploadImgBtn} from "../../buttons";
import {FormInput, SelectTags, TextArea} from "../../input";
...
export const AdminCreateArticle = ({setClose, openStatus}: Props) => {
    ...
    const handleClick = () => {
        ...
        dipatch(
            postCrateArticleAction.trigger({
                body: {
                    ...state,
                    tags: arr,
                },
