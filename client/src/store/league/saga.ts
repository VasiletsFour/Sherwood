...
import {TOURNAMENT_TABLE_URL} from "../../utils/urls";
...
export function* LeagueSaga() {
    while (true) {
        ...
        const leagueUrlMatch = action.type === LOCATION_CHANGE && TOURNAMENT_TABLE_URL.match(action.payload.location).isMatched;
