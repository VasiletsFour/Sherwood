...
import {AdminPlayerApi, PlayerBody, PlayerUpdate} from "../../request/PlayerApi";

export const getAdminPlayerListAction = defineApiCallAction<{}, { data: AdminPlayerApi[] }, { error: string }>("get-admin-player-list");
